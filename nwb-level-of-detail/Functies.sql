...
-- (7) DEZELFDE WEGMENTEN SAMENVOEGEN
---------------------------------------------------------------------------------------------------------------
DROP FUNCTION IF EXISTS dezelfde_wegmenten_samenvoegen(text);
CREATE FUNCTION dezelfde_wegmenten_samenvoegen(zelfde_bst text) RETURNS void AS $$
BEGIN
	...
	WHERE A.wegment_id < A.wegment_id_buurman;

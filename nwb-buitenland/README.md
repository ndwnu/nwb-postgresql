...
Deze zorgen ervoor dat ruimtelijke queries (zoals ST_Intersects, ST_DWithin, etc.) snel worden uitgevoerd.
...
De grensovergangen tussen de studiegebieden (bijv. Nederland–OSM) worden nodig om OSM-wegvakken op de grens te splitsen.

Door de grens een kleine buffer te geven (0.01 meter) worden nauwkeurigheidsproblemen vermeden.
